...
namespace MVCProductsApp.Controllers
{
    public class FeedbackController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Email,Content,Rating")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Content,Rating")] Feedback feedback)
        {
            if (ModelState.IsValid)
            {
